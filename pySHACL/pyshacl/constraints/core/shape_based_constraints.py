...
class QualifiedValueShapeConstraintComponent(ConstraintComponent):
    ...
    def __init__(self, shape):
        ...
        self.conformant_focus_value_nodes = {}
        self.non_conformant_focus_value_nodes = {}
    @classmethod
    def constraint_parameters(cls):
    ...
    def _evaluate_value_shape(
        ...
        for f, value_nodes in focus_value_nodes.items():
            number_conforms = 0
            conformant_focus_value_nodes = []
            non_conformant_focus_value_nodes = []
            for v in value_nodes:
                try:
                    ...
                    if _is_conform:
                        ...
                        if not _conforms_to_sibling:
                            number_conforms += 1
                            conformant_focus_value_nodes.append(v)
                        else:
                            non_conformant_focus_value_nodes.append(v)
                except ValidationFailure as v:
                    raise v
            self.conformant_focus_value_nodes[f] = conformant_focus_value_nodes
            self.non_conformant_focus_value_nodes[f] = non_conformant_focus_value_nodes
